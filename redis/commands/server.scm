;;; (redis commands server) --- redis module for Guile.
...
(define-module (redis commands server)
  #:use-module (redis commands define)
  #:export (bgrewriteaof bgsave client-kill client-list
...
;;; (redis commands server) ends here
